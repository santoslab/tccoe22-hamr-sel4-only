  ...
  case Some(o: Cli.TranspileOption) =>
    if(o.legacy) {
      ...
      val main: ISZ[String] = ISZ(
        ...
        "--string-size", "256",
        "--sequence-size", "16",
        "--sequence", s"IS[Z,art.Bridge]=3;MS[Z,Option[art.Bridge]]=3;IS[Z,art.UPort]=5;IS[Z,art.UConnection]=4",
        "--constants", s"art.Art.maxComponents=3;art.Art.maxPorts=13",
        "--forward", "art.ArtNative=t.ArtNix,t.Platform=t.PlatformNix",
        "--stack-size", "110592",
        "--stable-type-id",
