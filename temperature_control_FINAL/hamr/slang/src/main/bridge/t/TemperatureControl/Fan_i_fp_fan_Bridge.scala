...
import art._
import t._
import t.TemperatureControl.{Fan_i_fp_fan => component}

// This file was auto-generated.  Do not edit

@datatype class Fan_i_fp_fan_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Fan_i_Initialization_Api = {
    ...
    Fan_i_fp_fan_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Fan_i_Operational_Api = {
    ...
    Fan_i_fp_fan_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Fan_i_fp_fan_Bridge.EntryPoints(
      id,
...
object Fan_i_fp_fan_Bridge {
  ...
  @datatype class EntryPoints(
    Fan_i_fp_fan_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Fan_i_fp_fan_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == fanCmd_Id){
          ...
          // implement the following in 'component':  def handle_fanCmd(api: Fan_i_Operational_Api, value: TemperatureControl.FanCmd.Type): Unit = {}
