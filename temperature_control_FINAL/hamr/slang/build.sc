...
//   $SIREUM_HOME/bin/mill t.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill t.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w t.tests.compile
//
// Visual Studio Code:
...
object `t` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("t.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("t.InspectorDemo") }
