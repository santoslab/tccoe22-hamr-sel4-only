...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "TempControl_i_tcp_tempControl_App.scala", "t.TempControl_i_tcp_tempControl_App", "<App>", 0);
  ...
  return (int) t_TempControl_i_tcp_tempControl_App_main(SF &t_args);
}