...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "TempSensor_i_tsp_tempSensor_App.scala", "t.TempSensor_i_tsp_tempSensor_App", "<App>", 0);
  ...
  return (int) t_TempSensor_i_tsp_tempSensor_App_main(SF &t_args);
}