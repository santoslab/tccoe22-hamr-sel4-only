...
B t_TemperatureControl_TempSensor_i_Initialization_Api__ne(t_TemperatureControl_TempSensor_i_Initialization_Api this, t_TemperatureControl_TempSensor_i_Initialization_Api other);
...
void t_TemperatureControl_TempSensor_i_Initialization_Api_string_(STACK_FRAME String result, t_TemperatureControl_TempSensor_i_Initialization_Api this) {
  DeclNewStackFrame(caller, "TempSensor_i_Api.scala", "t.TemperatureControl.TempSensor_i_Initialization_Api", "string", 0);
  String_string_(SF result, string("TempSensor_i_Initialization_Api("));
  String sep = string(", ");
...
void t_TemperatureControl_TempSensor_i_Initialization_Api_cprint(t_TemperatureControl_TempSensor_i_Initialization_Api this, B isOut) {
  ...
  String_cprint(string("TempSensor_i_Initialization_Api("), isOut);
  String sep = string(", ");
...
B t_TemperatureControl_TempSensor_i_Initialization_Api__is(STACK_FRAME void* this);
t_TemperatureControl_TempSensor_i_Initialization_Api t_TemperatureControl_TempSensor_i_Initialization_Api__as(STACK_FRAME void *this);
...
void t_TemperatureControl_TempSensor_i_Initialization_Api_apply(STACK_FRAME t_TemperatureControl_TempSensor_i_Initialization_Api this, Z id, Z currentTemp_Id, Z tempChanged_Id) {
  DeclNewStackFrame(caller, "TempSensor_i_Api.scala", "t.TemperatureControl.TempSensor_i_Initialization_Api", "apply", 0);
  this->id = id;
