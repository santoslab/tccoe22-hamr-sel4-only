...
B art_Port_2ED9E6__ne(art_Port_2ED9E6 this, art_Port_2ED9E6 other);
...
B art_Port_2ED9E6__is(STACK_FRAME void* this);
art_Port_2ED9E6 art_Port_2ED9E6__as(STACK_FRAME void *this);

void art_Port_2ED9E6_apply(STACK_FRAME art_Port_2ED9E6 this, Z id, String name, art_PortMode_Type mode) {
  DeclNewStackFrame(caller, "ArchitectureDescription.scala", "art.art_Port_2ED9E6", "apply", 0);
  this->id = id;
