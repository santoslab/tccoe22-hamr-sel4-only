...
B art_Port_216126__ne(art_Port_216126 this, art_Port_216126 other);
...
B art_Port_216126__is(STACK_FRAME void* this);
art_Port_216126 art_Port_216126__as(STACK_FRAME void *this);

void art_Port_216126_apply(STACK_FRAME art_Port_216126 this, Z id, String name, art_PortMode_Type mode) {
  DeclNewStackFrame(caller, "ArchitectureDescription.scala", "art.art_Port_216126", "apply", 0);
  this->id = id;
