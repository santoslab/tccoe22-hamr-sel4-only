...
B art_Port_0A16CC__ne(art_Port_0A16CC this, art_Port_0A16CC other);
...
B art_Port_0A16CC__is(STACK_FRAME void* this);
art_Port_0A16CC art_Port_0A16CC__as(STACK_FRAME void *this);

void art_Port_0A16CC_apply(STACK_FRAME art_Port_0A16CC this, Z id, String name, art_PortMode_Type mode) {
  DeclNewStackFrame(caller, "ArchitectureDescription.scala", "art.art_Port_0A16CC", "apply", 0);
  this->id = id;
