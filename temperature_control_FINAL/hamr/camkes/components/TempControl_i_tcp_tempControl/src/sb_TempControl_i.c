...
Unit t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_fanCmd_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_fanCmd_Send", 0);

  sb_fanCmd_enqueue(d);
}

// is_empty currentTemp: In DataPort
B t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_currentTemp_IsEmpty(STACK_FRAME_ONLY) {
  return sb_currentTemp_is_empty();
}

// receive currentTemp: In DataPort union_art_DataContent
Unit t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_currentTemp_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_currentTemp_Receive", 0);
...
B t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_fanAck_IsEmpty(STACK_FRAME_ONLY) {
  return sb_fanAck_is_empty();
}

// receive fanAck: In EventDataPort union_art_DataContent
Unit t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_fanAck_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_fanAck_Receive", 0);
...
B t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_tempChanged_IsEmpty(STACK_FRAME_ONLY) {
  return sb_tempChanged_is_empty();
}

// receive tempChanged: In EventPort
Unit t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_tempChanged_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_tempChanged_Receive", 0);
...
B t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_setPoint_IsEmpty(STACK_FRAME_ONLY) {
  return T;
}

// FIXME: dummy implementation for unconnected incoming port
Unit t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_setPoint_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_TempControl_i.c", "", "t_TemperatureControl_TempControl_i_tcp_tempControl_seL4Nix_setPoint_Receive", 0);
...
void pre_init(void) {
  ...
  t_TemperatureControl_TempControl_i_tcp_tempControl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  t_TemperatureControl_TempControl_i_tcp_tempControl_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    t_TemperatureControl_TempControl_i_tcp_tempControl_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
